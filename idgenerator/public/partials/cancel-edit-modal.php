  ...
  <div class="modal-dialog modal-md ">
      ...
      <div class="modal-footer white-bg no-brd no-mg no-bx-sdw pd-15">
          <div class="col-md-12 mg-t-20">
            <button type="button" class="green-bg pd-tb-10 pd-lr-30 text-center white no-brd" id="yesCancel"><i class="fa fa-check mg-r-5"></i>Yes</button>
            <button type="button" data-dismiss="modal" class="orange-bg pd-tb-10 pd-lr-30 text-center white no-brd"><i class="fa fa-remove mg-r-5"></i>No</button>
          </div>  
      </div>
  </div>
</div>
